...
unit TheMovieDB_misc_utils_unit;
...
const
  ...
  URLIdentifier     : String = 'Zoom Player (scraper plugin)';
...
begin
  ...
  Begin
    ...
    // used to diagnose TheMovieDB's cloudflare errors
    If Status = '403' then
    Begin
      sList := TStringList.Create;
      iStream.Position := 0;
      sList.LoadFromStream(iStream);
      MessageBox(0,PChar(sList.Text),nil,MB_OK);
      sList.Free;
    End;
  End};
  iStream.Free;
